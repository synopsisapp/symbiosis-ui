...
export const iconButton = (variants: IconButtonVariants & ButtonHeightSizingVariants) => cn(
...
export const button = (variants: ButtonVariants) => cn(
  buttonCva(variants),
  buttonHeightSizing({ size: variants.size }),
);
...
const buttonCva = cva([
  ...
  variants: {
    variant: {
      primary: [
        'bg-mainColors-base', 'text-white',
        'border-mainColors-base', 'border-[1px]', 'border-solid',
        'hover:bg-mainColors-dark-100', 'hover:border-mainColors-dark-100',
        'active:bg-mainColors-dark-20', 'active:border-mainColors-dark-20',
        'disabled:bg-gray-400', 'disabled:border-gray-400'
      ],
      outline: [
        'bg-transparent', 'text-mainColors-dark-100',
        'border-mainColors-dark-100', 'border-[1px]', 'border-solid',
        'hover:bg-mainColors-light-400',
        'active:bg-mainColors-light-300',
        'disabled:border-gray-400', 'disabled:text-grays-400'
      ],
      ghost: [
        'bg-transparent', 'text-mainColors-dark-100',
        'hover:bg-mainColors-light-400',
